import {createId, getRandomInteger, createRandomId, getRandomArrayElement} from './value-generation.js';
...
export const createArrayDescriptions = (lengthArray) => Array.from({length:lengthArray}, createPhotoDescription);
